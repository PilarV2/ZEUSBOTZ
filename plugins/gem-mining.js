let handler = async (m, { conn }) => {
   ...
   if ( user.pickaxe > 0 ) {
    ...
    conn.sendButtonLoc(m.chat, await(await fetch(fla + 'MINING')).buffer(),`Kamu Menambang Di ${pickRandom(['⛰️Lembah', '⛰️Goa mletre', '🏞️Sungai Selandia', '⛰️Goa texas', '...'])}\n*⚒️Hasil Tambang*\n💎Diamond: *${minsm}*\n🪙Emas: *${minim}*\n⛓️Besi: *${minam}*\n🕸️String: *${minkm}*\nDan Juga Kamu Mendapatkan Hadiah Rare Tambahan\n🗳️Mythic Crate:*${minbm}*`, wm, '⋮☰ INV', '.inv', m)
